...
function render(input, out, __component, component, state) {
  ...
  out.w("<div class=\"card o-hidden border-0 shadow-lg my-5\"><div class=\"card-body p-0\"><div class=row><div class=\"col-lg-6 d-none d-lg-block bg-login-image\"></div><div class=col-lg-6><div class=p-5><div class=text-center><h1 class=\"h4 text-gray-900 mb-4\">Bem-vindo à Artha!</h1></div><form method=post action class=user><div class=form-group><input type=email class=\"form-control form-control-user\" id=email name=email aria-describedby=email placeholder=\"Digite seu email...\"></div><div class=form-group><input type=password class=\"form-control form-control-user\" id=senha name=senha placeholder=Senha></div><div class=form-group><div class=\"custom-control custom-checkbox small\"><input type=checkbox class=custom-control-input id=customCheck><label class=custom-control-label for=customCheck>Lembrar Senha</label></div></div><input type=submit value=Entrar class=\"btn btn-primary btn-user btn-block\"><hr></form><hr><div class=text-center><a class=small href=forgot-password.html>Esqueçeu sua senha?</a></div><div class=text-center><a class=small href=/cadastro>Criar conta!</a></div></div></div></div></div></div></div></div></div><script src=static/vendor/jquery/jquery.min.js></script><script src=static/vendor/bootstrap/js/bootstrap.bundle.min.js></script><script src=static/vendor/jquery-easing/jquery.easing.min.js></script><script src=static/assets/js/sb-admin-2.min.js></script><script src=static/assets/js/login-js/login.js></script>");
